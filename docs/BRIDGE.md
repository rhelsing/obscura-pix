...
- **Nothing parses a payload, on either side.** `data` / `payload` cross as
  ...
  ([`NATIVE_CONTRACT.md` §0.4](https://github.com/barrelmaker97/obscura-native/blob/a6151b3/docs/NATIVE_CONTRACT.md)); the app parses them once, on
...
### The inbox ([`KIT_API.md` §3](https://github.com/barrelmaker97/obscura-native/blob/a6151b3/docs/KIT_API.md))
...
### The entry store ([`KIT_API.md` §8.1](https://github.com/barrelmaker97/obscura-native/blob/a6151b3/docs/KIT_API.md))
...
### Send ([`KIT_API.md` §5](https://github.com/barrelmaker97/obscura-native/blob/a6151b3/docs/KIT_API.md))
